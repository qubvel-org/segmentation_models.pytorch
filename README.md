...
Backbone from SegFormer pretrained on Imagenet! Can be used with all other decoders from package, so you can combine Mix Visual Transformer with Unet, FPN and others!
